    ...
    <div class="container">
        <div class="col-md-8 col-md-offset-2" id="myTabContent">
            ...
            <div style="color: #7aa92f;margin-top: -10px;">
                <p>开始时间：<?php echo ($activity["begin_time"]); ?></p>
                <p>结束时间：<?php echo ($activity["end_time"]); ?></p>
            </div>
            <p style="font-size: 1.2em;">&nbsp&nbsp&nbsp&nbsp<?php echo ($activity["content"]); ?></p>

            <div style="float: right;">
                <button id="<?php echo ($activity["activity_id"]); ?>" style="background-color: #78be09;color: white">
